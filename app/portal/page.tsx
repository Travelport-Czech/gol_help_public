            ...
            <div className={s.panelsRow}>
              ...
              <div className={s.panel}>
                ...
                <div className={s.panelBody}>
                  <div className={s.releaseVersion}>{latestRelease.version}</div>
                  <ul className={s.releaseList}>
                    {latestRelease.items.map((item) => <li key={item.title}>{item.title}</li>)}
                  </ul>
              ...
              <a
                href="https://www.youtube.com/@ceetravelsystems"
                target="_blank"
                rel="noopener noreferrer"
                className={s.youtubePanelLink}
              >
                <div className={s.youtubePanel}>
                  <div className={s.youtubePanelIcon}>
                  ...
                  <div className={s.youtubePanelText}>
                    <span className={s.youtubePanelTitle}>Video tutorials</span>
                    <span className={s.youtubePanelSub}>Watch step-by-step guides on our YouTube channel →</span>
                  </div>
                </div>
              </a>
