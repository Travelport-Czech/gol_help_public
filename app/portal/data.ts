...
export const CATEGORIES: Category[] = [
  {
    ...
    articles: [
      { title: "Agency detail – field reference", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-agency-agency-detail-description" },
      ...
      { title: "Contact info and billing details", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-agency-where-do-i-set-up-contact-information-and-billing-details" },
      { title: "Payment due date", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-agency-where-to-set-up-payment-due-date" },
      { title: "Manage payment methods appearance", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-agency-how-to-manage-appearance-of-your-payment-methods" },
  ...
  },
  {
    ...
    articles: [
      ...
      { title: "Default departure city", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-dealers-dealer-edit-how-to-set-up-default-city-for-departure" },
      { title: "Modify departure / arrival dates", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-dealers-dealer-edit-how-to-modify-dates-of-departure-and-arrival" },
      ...
      { title: "Company billing details", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-dealers-dealer-edit-company-billing-details" },
      { title: "Change agency logo", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-dealers-front-end-settings-where-can-you-insert-change-agency-logo" },
      { title: "Change front-end title", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-dealers-front-end-settings-how-do-you-change-the-title-of-your-front-end" },
      { title: "Insert favicon", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-dealers-front-end-settings-where-can-you-insert-favicon" },
      { title: "SEO text", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-dealers-front-end-settings-how-to-rewrite-our-text-for-seo" },
      { title: "Wait page", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-dealers-front-end-settings-wait-page-what-is-it-good-for" },
  ...
  },
  {
    ...
    href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-customers",
    articles: [
      { title: "Customers overview", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-gol-ibe-customers" },
  ...
  },
  {
    ...
    articles: [
      { title: "Handle bookings", href: "/portal/getting-started/1-gol-ibe-2-gol-ibe-step-by-step-reservations-gol-ibe-how-to-handle-bookings-in-admin-console" },
...
export const HEALTH_CHECKS: HealthCheck[] = [
  ...
  },
  {
    ...
    status: "pending",
    href: "/portal/getting-started/terms",
  },
  {
